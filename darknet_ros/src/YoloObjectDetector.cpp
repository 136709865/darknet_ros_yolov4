...
void* YoloObjectDetector::displayInThread(void* ptr) {
  ...
  // show_image_cv(buff_[(buffIndex_ + 1) % 3], "YOLO V4", ipl_);
...
IplImageWithHeader_ YoloObjectDetector::getIplImageWithHeader() {
  ...
  // IplImage* ROS_img = (IplImage*)&IplImage(camImageCopy_);
  // IplImage Matcopy_= IplImage(camImageCopy_);
  // IplImage* ROS_img = &Matcopy_;
  // IplImage* ROS_img = cvCloneImage(&(IplImage)camImageCopy_);
  // IplImage* ROS_img=
